...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            @guest  <!--SI NO ESTAMOS IDENTIFICADOS-->
                            <li class="nav-item">
    ...
    <footer>
    <p>Desarrollado por Darnell Armas &copy; <?= date('Y'); ?> <a href="https://github.com/DarArmas/Store-MVC" class="btn btn-success">Codigo Fuente</a></p>
</footer>
</html>
